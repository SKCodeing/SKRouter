...
extern NSString *const SKRouterParameterURL;
extern NSString *const SKRouterParameterCompletion;
extern NSString *const SKRouterParameterUserInfo;

/**
 *  routerParameters 里内置的几个参数会用到上面定义的 string
 */
typedef void (^SKRouterHandler)(NSDictionary *routerParameters);
 ...
 *  [SKRouter generateURLWithPattern:MGJ_ROUTE_BEAUTY, @[@13]];
 *
 *
