...
NSString *const SKRouterParameterURL = @"SKRouterParameterURL";
NSString *const SKRouterParameterCompletion = @"SKRouterParameterCompletion";
NSString *const SKRouterParameterUserInfo = @"SKRouterParameterUserInfo";
...
+ (void)registerURLPattern:(NSString *)URLPattern toHandler:(SKRouterHandler)handler
{
...
+ (void)openURL:(NSString *)URL withUserInfo:(NSDictionary *)userInfo completion:(void (^)(void))completion
{
    ...
    if (parameters) {
        SKRouterHandler handler = parameters[@"block"];
        if (completion) {
            parameters[SKRouterParameterCompletion] = completion;
        }
        if (userInfo) {
            parameters[SKRouterParameterUserInfo] = userInfo;
        }
        if (handler) {
...
- (NSMutableDictionary *)extractParametersFromURL:(NSString *)url
{
    ...
    parameters[SKRouterParameterURL] = url;
...
- (void)addURLPattern:(NSString *)URLPattern andHandler:(SKRouterHandler)handler
{
